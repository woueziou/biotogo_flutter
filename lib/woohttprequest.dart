...
//-----------------------------------HEROKU SERVER-----------------------------------------------------//
  ...
  Future<String> getToken() async {
    ...
    final response = await http.get(HEROKUTOKEN_SERVER + "braintreetoken.php",
        headers: headers);
  ...
  Future<bool> payNow(String nonce, double amount) async {
    ...
    final response = await http.get(
        HEROKUTOKEN_SERVER +
            "braintreepay.php?payment_method_nonce=${nonce}&amount=${amount}",
        headers: headers);
    if (response.statusCode == 200) {
...
//-----------------------------------WOOCOMMERCE SERVER-----------------------------------------------------//
  ...
  Future<CreateCustomerResponce> addCustomer(
    ...
    final response =
        await http.post(WP_JSON_WC + "customers", headers: headers, body: body);
  ...
  Future<CreateCustomerResponce> updateNewUser(
    ...
    final response = await http.put(WP_JSON_WC + "customers/${id}",
  ...
  Future<List> getProducts() async {
    ...
    final response =
        await http.get(WC_API + "products?filter[limit] =-1", headers: headers);

    if (response.statusCode == 200) {
      var responseJson = json.decode(response.body)["products"];
      return List<GetAllProducts>.from(
          responseJson.map((data) => GetAllProducts.fromJson(data)));
    } else {
      return List();
    }
  }
  ...
  Future<List> getProductCategories() async {
    ...
    final response =
        await http.get(WP_JSON_WC + "products/categories", headers: headers);
  ...
  Future putNewOrder(String payment_method, String payment_method_title) async {
    ...
    final response =
        await http.post(WP_JSON_WC + "orders", headers: headers, body: body);
  ...
  Future<List<int>> getShippingZones() async {
    ...
    final response =
        await http.get(WP_JSON_WC + "shipping/zones", headers: headers);
    if (response.statusCode == 200) {
      print(response.body);

      List responseJson = json.decode(response.body);
      List<int> shippingZoneId =
          List<int>.from(responseJson.map((data) => data["id"]).toList());
  ...
  Future<List<GetShippingZoneMethods>> getShippingZonesMethod(int id) async {
    ...
    final response = await http.get(WP_JSON_WC + "shipping/zones/$id/methods",
        headers: headers);
    if (response.statusCode == 200) {
      print(response.body);
  ...
  Future<String> getSettings() async {
    ...
    final response =
        await http.get(WP_JSON_WC + "settings/general", headers: headers);
    if (response.statusCode == 200) {
      print(response.body);

      List responseJson = json.decode(response.body);
      responseJson.forEach((element) {
        if (element["id"] == "woocommerce_currency") code = element["value"];
  ...
  Future<List<PaymentGatewayResponce>> getPaymentGatways() async {
    ...
    final response =
        await http.get(WP_JSON_WC + "payment_gateways", headers: headers);
    if (response.statusCode == 200) {
      print(response.body);

      List responseJson = json.decode(response.body);
      List<PaymentGatewayResponce> paymentGateway =
          List<PaymentGatewayResponce>.from(responseJson
              .map((data) => PaymentGatewayResponce.fromJson(data))
              .toList());
...
//-----------------------------------PAYMENTS-----------------------------------------------------//
  ...
  Future<String> getAuthPaypal() async {
    ...
    final response = await http.post(PAYPAL_SERVER + "oauth2/token",
  ...
  Future<Map> paymentPaypal(String token, double amount, double shippingAmount,
    ...
    final response = await http.post(PAYPAL_SERVER + "payments/payment",
  ...
  Future<bool> paymentPaypalExecute(
    ...
    final response = await http.post(executeUrl,
        headers: headers, body: json.encode(bodyMap).toString());
    if (response.statusCode == 200 || response.statusCode == 201) {
      print(response.body);
  ...
  Future<String> getTapUrl(
    ...
    final response = await http.post(TAP_SERVER + "charges",
        headers: headers, body: json.encode(bodyMap).toString());
    if (response.statusCode == 200) {
      print(response.body);
