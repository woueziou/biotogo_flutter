...
Map<String, Map<String, String>> _localizedValues = {
    ...
    'ar': { // Arabic
      ...
      PAYMENTDESCRIPTION: "اجعل الطلب سهلاً لمنتجاتك المحددة بطريقة مباشرة ، انقر فوق إرسال الطلب لمواصلة الدفع وتسليم الطلب إلى إضافاتك الشخصية.",
      TOTAL: "مجموع",
      ...
      ABOUTUS: "معلومات عنا",
      ABOUTUSSHORTDESCRIPTION: "مجتمع تعاوني لأي شخص مهتم بتطوير التطبيقات باستخدام Flutter و Dart.",
      CONTACTUS: "اتصل بنا",
    ...
    'de': {// German
      ...
      PAYMENTDESCRIPTION: "Machen Sie die Bestellung für Ihre ausgewählten Produkte einfach. Klicken Sie auf Bestellung senden, um die Zahlung fortzusetzen und die Lieferung an Ihre persönlichen Adressen zu bestellen.",
      TOTAL: "Gesamt",
      ...
      ABOUTUS: "Über uns",
      ABOUTUSSHORTDESCRIPTION: "Eine kollaborative Community für alle, die Apps mit Flutter und Dart entwickeln möchten.",
    ...
    'fr': {// French
      ...
      PAYMENTDESCRIPTION: "Rendez la commande facile pour vos produits sélectionnés avec un simple, cliquez sur soumettre la commande pour continuer le paiement et la livraison de la commande à vos adresses personnelles.",
      TOTAL: "Total",
      ...
      ABOUTUSSHORTDESCRIPTION: "Une communauté collaborative pour tous ceux qui souhaitent développer des applications à l'aide de Flutter et Dart.",
    ...
    'ja': {// Japanese
      ...
      PAYMENTDESCRIPTION: "選択した製品を簡単に注文できるようにします。[注文を送信]をクリックして、支払いを続行し、個人の住所に注文を配送します。",
      TOTAL: "合計",
    ...
    'es': {// Spanish
      ...
      PAYMENTDESCRIPTION: "Haga que el pedido sea fácil para sus productos seleccionados de forma sencilla. Haga clic en enviar pedido para continuar con el pago y la entrega del pedido a sus direcciones personales.",
      TOTAL: "Total",
      ...
      ABOUTUSSHORTDESCRIPTION: "Una comunidad colaborativa para cualquier persona interesada en desarrollar aplicaciones usando Flutter y Dart.",
