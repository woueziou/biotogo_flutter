...
class HomeProductListView extends StatefulWidget {
  ...
  const HomeProductListView({Key key, this.products, this.callBack}) : super(key: key);
  @override
  _PopularProductGridViewState createState() => _PopularProductGridViewState();
}

class _PopularProductGridViewState extends State<HomeProductListView> with TickerProviderStateMixin {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      data.on_sale?Image.asset("assets/sale.png",width: 40,height: 40,):Container(width: 40,height: 40,),
